<head>
    <meta charset="utf-8" />
        <title>Sistem Informasi Pengelolaan Data Nelayan dan Hasil Produksi Ikan Tangkap | Login</title>
    ...
    <body class="login">
        <div class="logo">
            <a href="index.php">
                <img src="assets/pages/img/logo-big.gif" style="width:10%" /> </a>
        </div>
        <div class="content">
            <form class="login-form" id="frm_login" action="act-login.php?op=in" method="post">
                <h3 class="form-title font-green">Silahkan Login.</h3>
                <div class="alert alert-danger display-hide">
                    <button class="close" data-close="alert"></button>
                    <span> Mohon masukkan username dan password. </span>
                </div>
        ...
        <div class="copyright"> 2017 © Kharisma. </div>
        <!--[if lt IE 9]>
