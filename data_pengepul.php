                ...
                <div class="page-sidebar-wrapper">
                    ...
                    <div class="page-sidebar navbar-collapse collapse">
                        ...
                        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                            ...
                            <li class="nav-item">
                                <a href="data_nelayan.php" class="nav-link nav-toggle">
                                    <i class="icon-users"></i>
                                    <span class="title">Data Nelayan</span>
                                </a>
                            </li> 
                            <li class="nav-item start active open">
                                <a href="data_pengepul.php" class="nav-link nav-toggle">
                                    <i class="icon-users"></i>
                                    <span class="title">Data Pengepul</span>
                                    <span class="selected"></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="data_jenis_ikan.php" class="nav-link nav-toggle">
                                    <i class="icon-puzzle"></i>
                                    <span class="title">Data Jenis Ikan</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="data_hasil_produksi.php" class="nav-link nav-toggle">
                                    <i class="icon-loop"></i>
                                    <span class="title">Data Hasil Produksi</span>
                                </a>
                            </li>
                            <li class="heading">
                                <h3 class="uppercase">Data Transaksi</h3>
                            </li>
                            <li class="nav-item">
                                <a href="master_transaksi.php" class="nav-link nav-toggle">
                                    <i class="icon-note"></i>
                                    <span class="title">Hasil Tangkapan</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="data_transaksi.php" class="nav-link nav-toggle">
                                            ...
                                            <table class="table table-striped table-bordered table-advance table-hover">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_nelayan.php?id=<?php echo $data['id_nelayan']; ?>" class="btn btn-outline btn-circle btn-sm yellow" ><i class="fa fa-edit"></i> Edit </a>
                                                            <a href="hapus_nelayan.php?id=<?php echo $data['id_nelayan']; ?>" class="btn btn-outline btn-circle btn-sm red" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA INI ... ?')"><i class="fa fa-edit"></i> Hapus </a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                <?php } ?>
