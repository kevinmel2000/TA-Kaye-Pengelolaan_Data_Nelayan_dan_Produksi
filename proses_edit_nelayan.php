...
$alamat_nelayan = $_POST['alamat_nelayan'];
		...
		$query = mysql_query("update data_nelayan set nama_nelayan='$nama_nelayan', tempat_lahir_nelayan ='$tempat_lahir_nelayan',tanggal_lahir_nelayan ='$tanggal_lahir_nelayan', alamat_nelayan='$alamat_nelayan'  where id_nelayan='$id_nelayan'") or die(mysql_error());
